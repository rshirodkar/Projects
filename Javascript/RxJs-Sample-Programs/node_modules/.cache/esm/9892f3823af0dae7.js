let Observable,Subscriber,map,filter;_3af‍.w("rxjs",[["Observable",["Observable"],function(v){Observable=v}],["Subscriber",["Subscriber"],function(v){Subscriber=v}]]);_3af‍.w("rxjs/operators",[["map",["map"],function(v){map=v}],["filter",["filter"],function(v){filter=v}]]);// import necessary functions and operators from RxJS
